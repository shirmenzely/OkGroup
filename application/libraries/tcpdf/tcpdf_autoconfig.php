...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'ok.png')) {
		$tcpdf_header_logo = 'ok.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'O.K. GROUP');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'O.K. GROUP');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'O.K. GROUP חברת');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "חברה ליעוץ ארגוני, הפקת אירועים והפקת פרויקטים ");
}
