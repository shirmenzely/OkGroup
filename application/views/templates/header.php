...
<body>
    <header>
        ...
        <nav class="topnav" id="myTopnav">
            ...
            <a href="<?php echo site_url(); ?>/pages/index" class="active"><i class="fa fa-fw fa-home"> </i> דף הבית
            </a>
            ...
            if ($user['manager'] == 1) { ?>
                ...
                <a href="<?php echo site_url(); ?>/employee_portal/getCalendar" id="contact">יומן אירועים </a>
            ...
            ?>
                <a id="login" href="<?php echo site_url(); ?>/Login/login"><i class="fa fa-fw fa-user"> </i> התחברות / הרשמה
                    </a>
            <?php } ?>
        </nav>
